...
Charitable Trust’ and the terms &quot;You&quot; /&quot;Your&quot; / &quot;Yourself&quot; refer to the users.
          </Typography>
          <Typography variant="h6" color="text.secondary" component="div" sx={{px:4,py:2}}>
...
This Privacy Policy is a legally binding document between you and the Organization (both terms defined
...
will govern the relationship between you and Us for your use of the website “www.thestrayarmy.com ”
(defined below).
          </Typography>
          <Typography variant="h6" color="text.secondary" component="div" sx={{px:4,py:2}}>
...
also that are beyond our control. We shall in no way be responsible in way for your use of such sites.5.
          </Typography>
            <Typography variant="h5" color="text.secondary" component="div" sx={{px:4,py:2}}>
            INFORMATION SHARING
          </Typography>
...
posting to the discussion areas is available to anyone with Internet access. 
